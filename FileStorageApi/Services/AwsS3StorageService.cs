...
{
    /// <summary>
    /// Service for handling file storage operations using AWS S3 storage.
    /// </summary>
    /// <param name="currentConfiguration"></param>
    /// <param name="logger"></param>
    public class AwsS3StorageService(IFileStorageConfig currentConfiguration, ILogger<IFileStorageService> logger)
        : IFileStorageService
    {
