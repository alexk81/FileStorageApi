...
{
    /// <summary>
    /// Service for handling file storage operations using Google Cloud Storage buckets.
    /// </summary>
    /// <param name="currentConfiguration"></param>
    /// <param name="logger"></param>
    public class GoogleBucketsStorageService(
        IFileStorageConfig currentConfiguration,
